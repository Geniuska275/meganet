...
export default function NYSCModal({ service, onClose }) {
  ...
  const handleSubmit = async (data) => {
    try {
      ...
      formData.append("kin_address", form.kin_address);
            ...
            {step === 1 && (
              <div className="space-y-4 vd-fade">
                ...
                <div>
                  ...
                  <input value={form.contact} onChange={update("contact")} placeholder="Contact" className={inputClass} style={selectStyle} />
                </div>
                <div>
                  <label className="text-xs uppercase tracking-widest opacity-60 block mb-1.5">Home Address</label>
                  <input value={form.kin_address} onChange={update("kin_address")} placeholder="Home Address" className={inputClass} style={selectStyle} />
                </div>
                <div>
                  <label className="text-xs uppercase tracking-widest opacity-60 block mb-1.5">Phone Number</label>
